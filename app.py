...
current_product = "product4"

# Load JSON data from a file
with open(f'{current_product}/all_review_data.json', 'r') as file:
    review_data = json.load(file)
with open(f'{current_product}/top_Review_data.json', 'r') as file:
...
if current_product == "product1":
    ...
    product_data = {
        ...
        "price": "29.73",
        "company": "Hello Beautiful (Oprah's Book Club): A Novel (Random House Large Print)",
...
An exquisite homage to Louisa May Alcott’s timeless classic, Little Women, Hello Beautiful is a profoundly moving portrait of what is possible when we choose to love someone not in spite of who they are, but because of it.
    ...
    product_data = {
        ...
        "price": "29.73",
        "company": "The Heaven & Earth Grocery Store: A Novel (Random House Large Print)",
...
def serve_downloaded_page():
    ...
    if current_product == 'product1' or current_product == 'product2':
        ...
        return render_template('main-books.html', product=product_data, main_images=[list(item['main'].keys())[-2] for item in product_data['color_images']['initial']])
